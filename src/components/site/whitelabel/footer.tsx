      ...
      <div className="relative border-t border-ink/8 bg-paper py-20 text-center md:py-24">
        ...
        <div className="container-site relative flex flex-col items-center">
          ...
          >
            Your agency needs
            <br />
            <span className="text-gradient-brand">a dev who ships.</span>
          </motion.h2>
          ...
          >
            15 minutes. Tell me about your workload. Let&apos;s see if
            there&apos;s a fit.
          </motion.p>
          ...
          >
            ...
            <a
              href="/"
              className="inline-flex items-center gap-2 rounded-full border border-ink/15 bg-white/60 px-5 py-3.5 font-sans text-sm font-semibold text-ink/70 backdrop-blur transition-colors hover:text-ink"
            >
              ← Back to main site
            </a>
          </motion.div>
        ...
        <div className="container-site flex flex-col items-center justify-between gap-4 md:flex-row">
          <div className="flex items-center gap-2.5">
            ...
            <div className="font-sans text-xs">
              ...
              <div className="text-paper/60">White-label WordPress Development</div>
            </div>
          </div>
          ...
          >
            ...
            <div className="mt-4 space-y-3 font-sans text-sm leading-relaxed text-ink/65">
              ...
              <p>
                ...
                Discovery Call, the booking is handled by Selvinx
                (selvinx.com). Your name, email, and selected time are processed
                by Selvinx to schedule and confirm your appointment. Kaif
                receives these details directly. NDA available on request.
              </p>
              <p>
