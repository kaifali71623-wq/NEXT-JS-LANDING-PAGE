    ...
    <>
        ...
        <div className="container-site">
          ...
          >
            ...
            >
              ...
              <span className="hidden rounded-full bg-brand/10 px-2 py-0.5 font-sans text-[9px] font-bold uppercase tracking-wider text-brand sm:inline">
                White-label
              </span>
            </a>
            ...
            <div className="flex items-center gap-1.5">
              ...
              >
                <div className="relative h-3 w-4">
                  <span className={cn("absolute left-0 top-0 h-0.5 w-4 bg-ink transition-all", open && "top-1.5 rotate-45")} />
                  <span className={cn("absolute left-0 top-1.5 h-0.5 w-4 bg-ink transition-all", open && "opacity-0")} />
                  <span className={cn("absolute left-0 top-3 h-0.5 w-4 bg-ink transition-all", open && "top-1.5 -rotate-45")} />
                </div>
              </button>
            </div>
          </nav>
      ...
      >
        ...
        <div className={cn(
          ...
          <div className="mt-3">
            <AudienceSwitch current="agency" variant="mobile" />
          </div>
        </div>
      </div>
    </>
